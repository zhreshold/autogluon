...
from .scheduler_v1 import TaskSchedulerV1
...
class FIFOSchedulerV1(TaskSchedulerV1):
    ...
    def add_job(self, task, **kwargs):
        ...
        task_dict.update({'Task': task, 'Job': job, 'ReporterThread': None})
